...
SX1262Driver DMA_ATTR Radio;

expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    {0, RADIO_TYPE_SX126x_LORA, RATE_LORA_200HZ,     SX1262_LORA_BW_500, SX1262_LORA_SF6, SX1262_LORA_CR_4_7, 8,  TLM_RATIO_1_64, 4,  5000, OTA4_PACKET_SIZE, 1},
    {1, RADIO_TYPE_SX126x_LORA, RATE_LORA_100HZ_8CH, SX1262_LORA_BW_500, SX1262_LORA_SF6, SX1262_LORA_CR_4_8, 8,  TLM_RATIO_1_32, 4, 10000, OTA8_PACKET_SIZE, 1},
    {2, RADIO_TYPE_SX126x_LORA, RATE_LORA_100HZ,     SX1262_LORA_BW_500, SX1262_LORA_SF7, SX1262_LORA_CR_4_7, 8,  TLM_RATIO_1_32, 4, 10000, OTA4_PACKET_SIZE, 1},
    {3, RADIO_TYPE_SX126x_LORA, RATE_LORA_50HZ,      SX1262_LORA_BW_500, SX1262_LORA_SF8, SX1262_LORA_CR_4_7, 10, TLM_RATIO_1_16, 4, 20000, OTA4_PACKET_SIZE, 1},
    {4, RADIO_TYPE_SX126x_LORA, RATE_LORA_25HZ,      SX1262_LORA_BW_500, SX1262_LORA_SF9, SX1262_LORA_CR_4_7, 10, TLM_RATIO_1_8,  2, 40000, OTA4_PACKET_SIZE, 1}};
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {2, -117,  8770, 3500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(2.5)},
    {3, -120, 18560, 4000, 2500, 600, 5000, SNR_SCALE(-1), SNR_SCALE(1.5)},
    {4, -123, 29950, 6000, 4000,   0, 5000, SNR_SCALE(-3), SNR_SCALE(0.5)}};
#endif
