...
#elif defined(RADIO_SX127X) || defined(RADIO_SX126X) || defined(RADIO_LR1121)
...
#endif
#else
#error "Either RADIO_SX127X, RADIO_SX126X, RADIO_LR1121 or RADIO_SX128X must be defined!"
#endif
